 ...
 * tutorialreversisvelte implementation : © <Your name here> <Your email address here>
 *
...
namespace Bga\Games\tutorialreversisvelte;
...
class Game extends \Table
{
    ...
    function actPlayDisc( int $x, int $y )
    {
        ...
        if( count( $turnedOverDiscs ) > 0 )
        {
            ...
            throw new \BgaUserException("Impossible move");
        }
    }
...
//        $this->reattributeColorsBasedOnPreferences($players, $gameinfos["player_colors"]);
    ...
    function getBoard()
    {
        return self::getDoubleKeyCollectionFromDB(
            "SELECT board_x x, board_y y, board_player player FROM board", true
        );
    }
